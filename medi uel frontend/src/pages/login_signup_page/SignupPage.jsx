...
function SignupPage() {
  ...
  const handleSignup = async (e) => {
    ...
    try {
      const response = await fetch(
        "http://localhost:5005/api/v1/user/patient/register",
        {
          method: "POST",
          headers: {
      ...
      if (!response.ok) {
        ...
        // console.log(errorData?.message);  // Log the error message from the server
  ...
  return (
    <div
      ...
      style={{ backgroundColor: "rgb(179, 218, 217)", height:'150vh' }}
    >
      <Helmet>
